...
class YoutubeAutomationTasks():
    ...
    def manager_youtube_video_research(self, agent, video_topic, video_details):
         return Task(
    ...
    def create_youtube_video_titles(self, agent, video_topic, video_details):
        return Task(
    ...
    def create_youtube_video_email(self, agent, video_topic, video_details):
         return Task(
